  ...
  return (
    <nav className="absolute top-0 left-0 w-[90vw] z-10 mt-8" >
      <div className="flex justify-between items-center ml-[40px] md:ml-[80px]">
        <div>
          <img className="w-14 md:w-22" src="techiweb.jpg" alt="" />
        </div>
        ...
        <div className="flex gap-4 sm:gap-8">
          ...
          <Link to='/apply' className="px-4 py-1  md:px-5 flex items-center gap-2 md:py-2 rounded-full bg-blue-600 text-white font-medium">Apply <FaArrowUpRightFromSquare /></Link>
          <div>
